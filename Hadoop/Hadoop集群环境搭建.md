> 转载：[Hadoop集群环境搭建](https://github.com/heibaiying/BigData-Notes/blob/master/notes/installation/Hadoop%E9%9B%86%E7%BE%A4%E7%8E%AF%E5%A2%83%E6%90%AD%E5%BB%BA.md)

## 1. 集群规划

这里搭建一个 3 节点的 Hadoop 集群，其中三台主机均部署 `DataNode` 和 `NodeManager` 服务，但只有 hadoop001 上部署 `NameNode` 和 `ResourceManager` 服务。

![2020-10-18-0K7fNC](https://image.ldbmcs.com/2020-10-18-0K7fNC.jpg)
...
![2020-10-18-cCsUPH](https://image.ldbmcs.com/2020-10-18-cCsUPH.jpg)

点击 `Live Nodes` 进入，可以看到每个 `DataNode` 的详细情况：

![2020-10-18-pwt5mu](https://image.ldbmcs.com/2020-10-18-pwt5mu.jpg)

接着可以查看 Yarn 的情况，端口号为 `8088` ：

![2020-10-18-4GdSIj](https://image.ldbmcs.com/2020-10-18-4GdSIj.jpg)
